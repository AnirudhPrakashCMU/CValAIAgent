            ...
            try:
                ...
                try:
                    ...
                    if kind == "audio_chunk":
                        ...
                        logger.info(
                            f"[{client.client_id}] Received 'edit_component' from client (Session {client.session_id}). Spec ID: {data_dict.get('spec_id')}. TODO: Implement edit handling."
                        )
                    elif kind == "control_session":
                        # parsed_message = ClientControlMessage(**data_dict)
                        # TODO: Handle session control messages.
                        logger.info(
                            f"[{client.client_id}] Received 'control_session' from client (Session {client.session_id}). Action: {data_dict.get('action')}. TODO: Implement control handling."
                        )
